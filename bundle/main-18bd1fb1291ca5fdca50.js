...
/******/ 	var hotCurrentHash = "18bd1fb1291ca5fdca50"; // eslint-disable-line no-unused-vars
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return saveName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getName; });
const saveName = function (value1, value2) {
        localStorage.cinsUserName = value1;
        localStorage.cinsPassNum = value2;
};

const getName = function () {
        let arr = [];
        arr[0] = localStorage.cinsUserName;
        arr[1] = localStorage.cinsPassNum;
        console.log(arr[0]);
        return arr;
};
...
Object(__WEBPACK_IMPORTED_MODULE_3__pageOpen_js__["a" /* pageOpen */])();

let regis = document.querySelector('#registration');
regis.onclick = __WEBPACK_IMPORTED_MODULE_1__registration___default.a;

let rememberPass = document.querySelector('#checkBox');
rememberPass.onclick = __WEBPACK_IMPORTED_MODULE_2__rememberPassword_js__["a" /* rePassword */];
...
module.exports = __webpack_require__.p + "../loadedBackImg-db69007156eaf0bfe1424242452293df.jpg";
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return rePassword; });
...
const rePassword = function () {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__localStorage_js__["b" /* saveName */])(userName, passNum);
};
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return pageOpen; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__localStorage_js__ = __webpack_require__(1);
...
const pageOpen = function () {
    ...
    let arrNum = __WEBPACK_IMPORTED_MODULE_0__localStorage_js__["a" /* getName */];

    if (!!arrNum) {
        userName.innerHTML = arrNum[0];
        passNum.innerHTML = arrNum[1];
        // console.log(arrNum);
    }
};
